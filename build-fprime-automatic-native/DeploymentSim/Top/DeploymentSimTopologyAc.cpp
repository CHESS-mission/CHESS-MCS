// ======================================================================
// \title  DeploymentSimTopologyAc.cpp
// \author Generated by fpp-to-cpp
// \brief  cpp file for DeploymentSim topology
// ======================================================================

#include "DeploymentSim/Top/DeploymentSimTopologyAc.hpp"
...
namespace DeploymentSim {
  ...
  ChessSim::CsvTM csvTM(FW_OPTIONAL_NAME("csvTM"));
...
namespace DeploymentSim {
  ...
  namespace ConfigObjects {
    ...
    namespace CdhCore_health {
      Svc::Health::PingEntry pingEntries[NUM_PING_ENTRIES] = {
        ...
        {
          PingEntries::DeploymentSim_cmdSeq::WARN,
          PingEntries::DeploymentSim_cmdSeq::FATAL,
          "DeploymentSim_cmdSeq"
        },
        {
          PingEntries::DeploymentSim_rateGroup1::WARN,
          PingEntries::DeploymentSim_rateGroup1::FATAL,
          "DeploymentSim_rateGroup1"
        },
        {
          PingEntries::DeploymentSim_rateGroup2::WARN,
          PingEntries::DeploymentSim_rateGroup2::FATAL,
          "DeploymentSim_rateGroup2"
        },
        {
          PingEntries::DeploymentSim_rateGroup3::WARN,
          PingEntries::DeploymentSim_rateGroup3::FATAL,
          "DeploymentSim_rateGroup3"
        },
        {
  ...
  void initComponents(const TopologyState& state) {
    ...
    DeploymentSim::chronoTime.init(InstanceIds::DeploymentSim_chronoTime);
    DeploymentSim::cmdSeq.init(QueueSizes::DeploymentSim_cmdSeq, InstanceIds::DeploymentSim_cmdSeq);
    DeploymentSim::comDriver.init(InstanceIds::DeploymentSim_comDriver);
    DeploymentSim::csvTM.init(QueueSizes::DeploymentSim_csvTM, InstanceIds::DeploymentSim_csvTM);
    DeploymentSim::rateGroup1.init(QueueSizes::DeploymentSim_rateGroup1, InstanceIds::DeploymentSim_rateGroup1);
    DeploymentSim::rateGroup2.init(QueueSizes::DeploymentSim_rateGroup2, InstanceIds::DeploymentSim_rateGroup2);
    DeploymentSim::rateGroup3.init(QueueSizes::DeploymentSim_rateGroup3, InstanceIds::DeploymentSim_rateGroup3);
    DeploymentSim::rateGroupDriver.init(InstanceIds::DeploymentSim_rateGroupDriver);
    DeploymentSim::systemResources.init(InstanceIds::DeploymentSim_systemResources);
    DeploymentSim::timer.init(InstanceIds::DeploymentSim_timer);
  ...
  void setBaseIds() {
    DeploymentSim::csvTM.setIdBase(BaseIds::DeploymentSim_csvTM);
    ...
    DeploymentSim::rateGroup1.setIdBase(BaseIds::DeploymentSim_rateGroup1);
    DeploymentSim::rateGroup2.setIdBase(BaseIds::DeploymentSim_rateGroup2);
    DeploymentSim::rateGroup3.setIdBase(BaseIds::DeploymentSim_rateGroup3);
    DeploymentSim::cmdSeq.setIdBase(BaseIds::DeploymentSim_cmdSeq);
    DeploymentSim::chronoTime.setIdBase(BaseIds::DeploymentSim_chronoTime);
    DeploymentSim::rateGroupDriver.setIdBase(BaseIds::DeploymentSim_rateGroupDriver);
    DeploymentSim::systemResources.setIdBase(BaseIds::DeploymentSim_systemResources);
    DeploymentSim::timer.setIdBase(BaseIds::DeploymentSim_timer);
    DeploymentSim::comDriver.setIdBase(BaseIds::DeploymentSim_comDriver);
  }
  ...
  void connectComponents() {
    ...
    CdhCore::cmdDisp.set_seqCmdStatus_OutputPort(
        1,
        DeploymentSim::cmdSeq.get_cmdResponseIn_InputPort(0)
    );
    DeploymentSim::cmdSeq.set_comCmdOut_OutputPort(
        0,
    ...
    CdhCore::cmdDisp.set_compCmdSend_OutputPort(
        7,
        DeploymentSim::cmdSeq.get_cmdIn_InputPort(0)
    );
    CdhCore::cmdDisp.set_compCmdSend_OutputPort(
        8,
        DeploymentSim::csvTM.get_cmdIn_InputPort(0)
    );
    CdhCore::cmdDisp.set_compCmdSend_OutputPort(
        9,
        DeploymentSim::systemResources.get_CmdDisp_InputPort(0)
    );
    CdhCore::cmdDisp.set_compCmdSend_OutputPort(
        10,
    ...
    DeploymentSim::cmdSeq.set_cmdRegOut_OutputPort(
        0,
        CdhCore::cmdDisp.get_compCmdReg_InputPort(7)
    );
    DeploymentSim::csvTM.set_cmdRegOut_OutputPort(
        0,
        CdhCore::cmdDisp.get_compCmdReg_InputPort(8)
    );
    DeploymentSim::systemResources.set_CmdReg_OutputPort(
        0,
    ...
    DeploymentSim::cmdSeq.set_cmdResponseOut_OutputPort(
        0,
        CdhCore::cmdDisp.get_compCmdStat_InputPort(0)
    );
    DeploymentSim::csvTM.set_cmdResponseOut_OutputPort(
        0,
        CdhCore::cmdDisp.get_compCmdStat_InputPort(0)
    );
    DeploymentSim::systemResources.set_CmdStatus_OutputPort(
        0,
        CdhCore::cmdDisp.get_compCmdStat_InputPort(0)
    );
    ...
    ComCcsds::comStub.set_drvReceiveReturnOut_OutputPort(
        0,
        DeploymentSim::comDriver.get_recvReturnIn_InputPort(0)
    );
    ComCcsds::comStub.set_drvSendOut_OutputPort(
        0,
        DeploymentSim::comDriver.get_send_InputPort(0)
    );
    DeploymentSim::comDriver.set_allocate_OutputPort(
        0,
        ComCcsds::commsBufferManager.get_bufferGetCallee_InputPort(0)
    );
    DeploymentSim::comDriver.set_deallocate_OutputPort(
        0,
        ComCcsds::commsBufferManager.get_bufferSendIn_InputPort(0)
    );
    DeploymentSim::comDriver.set_ready_OutputPort(
        0,
        ComCcsds::comStub.get_drvConnected_InputPort(0)
    );
    DeploymentSim::comDriver.set_recv_OutputPort(
        0,
    ...
    DeploymentSim::cmdSeq.set_logOut_OutputPort(
        0,
        CdhCore::events.get_LogRecv_InputPort(0)
    );
    DeploymentSim::csvTM.set_logOut_OutputPort(
        0,
        CdhCore::events.get_LogRecv_InputPort(0)
    );
    DeploymentSim::rateGroup1.set_Log_OutputPort(
        0,
        CdhCore::events.get_LogRecv_InputPort(0)
    );
    DeploymentSim::rateGroup2.set_Log_OutputPort(
        0,
        CdhCore::events.get_LogRecv_InputPort(0)
    );
    DeploymentSim::rateGroup3.set_Log_OutputPort(
        0,
        CdhCore::events.get_LogRecv_InputPort(0)
    );
    DeploymentSim::systemResources.set_Log_OutputPort(
        0,
        CdhCore::events.get_LogRecv_InputPort(0)
    );
    ...
    CdhCore::health.set_PingSend_OutputPort(
        4,
        DeploymentSim::cmdSeq.get_pingIn_InputPort(0)
    );
    CdhCore::health.set_PingSend_OutputPort(
        5,
        DeploymentSim::rateGroup1.get_PingIn_InputPort(0)
    );
    CdhCore::health.set_PingSend_OutputPort(
        6,
        DeploymentSim::rateGroup2.get_PingIn_InputPort(0)
    );
    CdhCore::health.set_PingSend_OutputPort(
        7,
        DeploymentSim::rateGroup3.get_PingIn_InputPort(0)
    );
    CdhCore::health.set_PingSend_OutputPort(
        8,
    ...
    DeploymentSim::cmdSeq.set_pingOut_OutputPort(
        0,
        CdhCore::health.get_PingReturn_InputPort(4)
    );
    DeploymentSim::rateGroup1.set_PingOut_OutputPort(
        0,
        CdhCore::health.get_PingReturn_InputPort(5)
    );
    DeploymentSim::rateGroup2.set_PingOut_OutputPort(
        0,
        CdhCore::health.get_PingReturn_InputPort(6)
    );
    DeploymentSim::rateGroup3.set_PingOut_OutputPort(
        0,
    ...
    DeploymentSim::csvTM.set_prmGetOut_OutputPort(
        0,
        FileHandling::prmDb.get_getPrm_InputPort(0)
    );
    DeploymentSim::csvTM.set_prmSetOut_OutputPort(
        0,
        FileHandling::prmDb.get_setPrm_InputPort(0)
    );

    // RateGroups
    DeploymentSim::rateGroup1.set_RateGroupMemberOut_OutputPort(
        0,
    ...
    DeploymentSim::rateGroup1.set_RateGroupMemberOut_OutputPort(
        2,
        DeploymentSim::systemResources.get_run_InputPort(0)
    );
    DeploymentSim::rateGroup1.set_RateGroupMemberOut_OutputPort(
        3,
    ...
    DeploymentSim::rateGroup1.set_RateGroupMemberOut_OutputPort(
        5,
        DeploymentSim::csvTM.get_schedIn_InputPort(0)
    );
    DeploymentSim::rateGroup2.set_RateGroupMemberOut_OutputPort(
        0,
        DeploymentSim::cmdSeq.get_schedIn_InputPort(0)
    );
    DeploymentSim::rateGroup3.set_RateGroupMemberOut_OutputPort(
        0,
    ...
    DeploymentSim::rateGroupDriver.set_CycleOut_OutputPort(
        0,
        DeploymentSim::rateGroup1.get_CycleIn_InputPort(0)
    );
    DeploymentSim::rateGroupDriver.set_CycleOut_OutputPort(
        1,
        DeploymentSim::rateGroup2.get_CycleIn_InputPort(0)
    );
    DeploymentSim::rateGroupDriver.set_CycleOut_OutputPort(
        2,
        DeploymentSim::rateGroup3.get_CycleIn_InputPort(0)
    );
    DeploymentSim::timer.set_CycleOut_OutputPort(
        0,
        DeploymentSim::rateGroupDriver.get_CycleIn_InputPort(0)
    );
    ...
    DeploymentSim::cmdSeq.set_tlmOut_OutputPort(
        0,
        CdhCore::tlmSend.get_TlmRecv_InputPort(0)
    );
    DeploymentSim::csvTM.set_tlmOut_OutputPort(
        0,
        CdhCore::tlmSend.get_TlmRecv_InputPort(0)
    );
    DeploymentSim::rateGroup1.set_Tlm_OutputPort(
        0,
        CdhCore::tlmSend.get_TlmRecv_InputPort(0)
    );
    DeploymentSim::rateGroup2.set_Tlm_OutputPort(
        0,
        CdhCore::tlmSend.get_TlmRecv_InputPort(0)
    );
    DeploymentSim::rateGroup3.set_Tlm_OutputPort(
        0,
        CdhCore::tlmSend.get_TlmRecv_InputPort(0)
    );
    DeploymentSim::systemResources.set_Tlm_OutputPort(
        0,
        CdhCore::tlmSend.get_TlmRecv_InputPort(0)
    );
    ...
    DeploymentSim::cmdSeq.set_LogText_OutputPort(
        0,
        CdhCore::textLogger.get_TextLogger_InputPort(0)
    );
    DeploymentSim::csvTM.set_logTextOut_OutputPort(
        0,
        CdhCore::textLogger.get_TextLogger_InputPort(0)
    );
    DeploymentSim::rateGroup1.set_LogText_OutputPort(
        0,
        CdhCore::textLogger.get_TextLogger_InputPort(0)
    );
    DeploymentSim::rateGroup2.set_LogText_OutputPort(
        0,
        CdhCore::textLogger.get_TextLogger_InputPort(0)
    );
    DeploymentSim::rateGroup3.set_LogText_OutputPort(
        0,
        CdhCore::textLogger.get_TextLogger_InputPort(0)
    );
    DeploymentSim::systemResources.set_LogText_OutputPort(
        0,
        CdhCore::textLogger.get_TextLogger_InputPort(0)
    );
    ...
    CdhCore::cmdDisp.set_Time_OutputPort(
        0,
        DeploymentSim::chronoTime.get_timeGetPort_InputPort(0)
    );
    ...
    DeploymentSim::cmdSeq.set_timeCaller_OutputPort(
        0,
        DeploymentSim::chronoTime.get_timeGetPort_InputPort(0)
    );
    DeploymentSim::csvTM.set_timeCaller_OutputPort(
        0,
        DeploymentSim::chronoTime.get_timeGetPort_InputPort(0)
    );
    DeploymentSim::rateGroup1.set_Time_OutputPort(
        0,
        DeploymentSim::chronoTime.get_timeGetPort_InputPort(0)
    );
    DeploymentSim::rateGroup2.set_Time_OutputPort(
        0,
        DeploymentSim::chronoTime.get_timeGetPort_InputPort(0)
    );
    DeploymentSim::rateGroup3.set_Time_OutputPort(
        0,
        DeploymentSim::chronoTime.get_timeGetPort_InputPort(0)
    );
    DeploymentSim::systemResources.set_Time_OutputPort(
        0,
        DeploymentSim::chronoTime.get_timeGetPort_InputPort(0)
    );
  ...
  void regCommands() {
    ...
    DeploymentSim::cmdSeq.regCommands();
    DeploymentSim::systemResources.regCommands();
  ...
  void startTasks(const TopologyState& state) {
    ...
    DeploymentSim::cmdSeq.start(
      static_cast<FwTaskPriorityType>(Priorities::DeploymentSim_cmdSeq),
      static_cast<Os::Task::ParamType>(StackSizes::DeploymentSim_cmdSeq),
      Os::Task::TASK_DEFAULT, // Default CPU
      static_cast<Os::Task::ParamType>(TaskIds::DeploymentSim_cmdSeq)
    );
    DeploymentSim::csvTM.start(
      static_cast<FwTaskPriorityType>(Priorities::DeploymentSim_csvTM),
      static_cast<Os::Task::ParamType>(StackSizes::DeploymentSim_csvTM),
      Os::Task::TASK_DEFAULT, // Default CPU
      static_cast<Os::Task::ParamType>(TaskIds::DeploymentSim_csvTM)
    );
    DeploymentSim::rateGroup1.start(
      static_cast<FwTaskPriorityType>(Priorities::DeploymentSim_rateGroup1),
      static_cast<Os::Task::ParamType>(StackSizes::DeploymentSim_rateGroup1),
      Os::Task::TASK_DEFAULT, // Default CPU
      static_cast<Os::Task::ParamType>(TaskIds::DeploymentSim_rateGroup1)
    );
    DeploymentSim::rateGroup2.start(
      static_cast<FwTaskPriorityType>(Priorities::DeploymentSim_rateGroup2),
      static_cast<Os::Task::ParamType>(StackSizes::DeploymentSim_rateGroup2),
      Os::Task::TASK_DEFAULT, // Default CPU
      static_cast<Os::Task::ParamType>(TaskIds::DeploymentSim_rateGroup2)
    );
    DeploymentSim::rateGroup3.start(
      static_cast<FwTaskPriorityType>(Priorities::DeploymentSim_rateGroup3),
      static_cast<Os::Task::ParamType>(StackSizes::DeploymentSim_rateGroup3),
      Os::Task::TASK_DEFAULT, // Default CPU
      static_cast<Os::Task::ParamType>(TaskIds::DeploymentSim_rateGroup3)
    );
  ...
  void stopTasks(const TopologyState& state) {
    ...
    DeploymentSim::cmdSeq.exit();
    DeploymentSim::csvTM.exit();
    DeploymentSim::rateGroup1.exit();
    DeploymentSim::rateGroup2.exit();
    DeploymentSim::rateGroup3.exit();
  ...
  void freeThreads(const TopologyState& state) {
    ...
    (void) DeploymentSim::cmdSeq.ActiveComponentBase::join();
    (void) DeploymentSim::csvTM.ActiveComponentBase::join();
    (void) DeploymentSim::rateGroup1.ActiveComponentBase::join();
    (void) DeploymentSim::rateGroup2.ActiveComponentBase::join();
    (void) DeploymentSim::rateGroup3.ActiveComponentBase::join();
