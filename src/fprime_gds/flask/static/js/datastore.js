    ...
    setupCommandArgument(argument) {
        ...
        // Serializable type
            ...
            let argument_list = argument.type.MEMBER_LIST.map((field_list) => {
                ...
                // Some dictionaries omit DEFAULT for serializable command arguments.
                // Treat missing defaults as null to avoid startup-time crashes.
                let defaults = (argument.type.DEFAULT && typeof argument.type.DEFAULT === "object")
                    ? argument.type.DEFAULT
                    : {};
                let default_val = (name in defaults) ? defaults[name] : null;
